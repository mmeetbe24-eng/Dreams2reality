...
- **Format:** PDF (`Lab_Eval_1_Report.pdf`, 18 Pages)
...
- [`Lab_Eval_1_Report.pdf`](Lab_Eval_1_Report.pdf) — Complete 18-page compiled report matching official TIET requirements.
